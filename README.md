...
- При первичном запуске приложения запустится процесс миграции - пользователь сможет найти у себя созданную БД tic_tac_toe_game с некоторыми начальными данными в некоторых таблицах
